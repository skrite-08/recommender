...
import com.sun.utils.SendEmail;
...
public class RegisterController {
	...
	@PostMapping(value = "getValidateCode.domain",produces = "text/html;charset=UTF-8")
	@ResponseBody
...
//		boolean isSuccessful=SendEmail.sendemail("邮箱验证", "您的验证码为："+code, email);
	...
	@PostMapping(value = "register.domain",produces = "text/html;charset=UTF-8")
	@ResponseBody
