package com.sun.method.filtering;
...
public class Userlevelfiltering {
    ...
    public static Map<Integer, float[]> getFrequencyMatrix(List<Integer> userIdList, final List<Integer> songIdList,
                                                           List<DownloadSongRecord> downloadList, List<PlaySongRecord> playList, List<LikingSong> collectionList) {
