...
<%--                &lt;%&ndash; <c:forEach items="${clickedSongList}" var="song" varStatus="status"> &ndash;%&gt;--%>
...
<%--                                </c:choose>--%>
<%--                        &lt;%&ndash; <c:if test="${song.whetherCollected}">class="collect m-r-sm text-danger" </c:if> &ndash;%&gt;--%>
...
<%--                <c:forEach items="${row}" var="user">--%>
                    <div class="col-lg-4">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                <a href="javascript:;"  class="card-link">${user.userName}</a>
                ...
                <div class="row content">
                    <div class="col-sm-5 ">
                        ...
                        <div>
                            ...
                            <button onclick="reviewSongFunc(${song.songId})" class="btn btn-outline-success my-2 my-sm-0 fl">发表</button>
                        </div>
