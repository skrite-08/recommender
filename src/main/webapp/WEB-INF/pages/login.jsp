...
<%--		<link rel="stylesheet" href="${pageContext.request.contextPath}/css/bootstrap-theme.min.css">--%>
	...
	<body>
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        ...
		        <form class="form-signin" id="register-submit">
			      <%--@declare id="inputpasswordagain"--%><h1 class="h3 mb-3 font-weight-normal">Please fill out info</h1>
		...
		<form class="form-signin text-center" id="form-signin-id" action="${pageContext.request.contextPath}/login.domain" method="post">
			        ...
			        $.ajax({
			            ...
			            success:function(data){
			                ...
			                if(res.status==200){
			                    ...
			                    window.location.href="${pageContext.request.contextPath}/info.domain";
			                }else{
