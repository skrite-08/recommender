...
<html lang="en">
	...
	<div class="container ">
		<form class="form-signin" id="form-applying-id" action="${pageContext.request.contextPath}/applyingInfo.domain"  method="post">
		...
		$(function(){
			$("#form-applying-id").submit(function(){
				$('#hot').load("applyingInfo.domain",$('#form-applying-id').serialize() );
		        return false;
			});
