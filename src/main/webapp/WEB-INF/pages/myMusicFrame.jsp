            ...
            <div class="row">
                <div class="col-4">
                    <div class="list-group" id="list-tab" role="tablist">
                        ...
                        <a class="list-group-item list-group-item-action " id="list-trending-list" data-toggle="list" href="#list-trending" role="tab" aria-controls="trending">个性推荐</a>
                    </div>
                </div>
                <div class="col-8">
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                            <ul class="list-group list-group-flush" >
                                <c:forEach items="${myLikeSongList}" var="song" varStatus="status">
                        ...
                        <!-- 个性推荐 -->
                        <div class="tab-pane fade" id="list-trending" role="tabpanel" aria-labelledby="list-profile-list">
                            <ul class="list-group list-group-flush" >
...
<script>
    $(function(){
        //$('#list-home').load("collectedFrameLoad.domain");
        $('#list-home').load("collectedFrameLoad.domain");
        //处理我的收藏tab切换
        ...
        $('#list-tab a[href="#list-profile"]').on('click', function (e) {
            $('#list-profile').load("recentFrameLoad.domain");
        });
        //处理个性推荐tab切换
        $('#list-tab a[href="#list-trending"]').on('click', function (e) {
            $('#list-trending').load("trendingFrameLoad.domain");
        });
    });


    function reviewSongLoad(songId){
        $('#hot').load("reviewSongFrameLoad.domain?songId="+songId);
    }
