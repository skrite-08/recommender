...
<%--		<link rel="stylesheet" href="${pageContext.request.contextPath}/css/bootstrap.min.css">--%>
	...
	<body>
		<form class="form-signin" id="form-getstarted-id" action="${pageContext.request.contextPath}/fillInfo.domain" enctype="multipart/form-data" method="post">
		  ...
		  <div class="mb-3">
		      <div class="form-check form-check-inline">
		      	<%--@declare id="exampleradios1"--%><input class="form-check-input" type="radio" name="gender" value="1" checked>
